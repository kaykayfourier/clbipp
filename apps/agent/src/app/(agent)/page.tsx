// /  —  Batch 1 · Aamir
//
// Day view. Assigned jobs, the three stats (Assigned / Collected / Earned
// today), offline banner, resumable-draft row. Jobs are PUSHED — no nearby-
// jobs feed (D2).
//
