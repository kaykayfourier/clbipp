...
// vendor-visibility rule. Nothing on this screen may ever appear in
// apps/customer.
//
...
export default function Page() {
  return (
    <AppShell title="Breakdown" showBack backHref="…/result" hideNav>
      <PagePadding>
        <h1 className="text-xl font-semibold text-text-primary">Breakdown</h1>
