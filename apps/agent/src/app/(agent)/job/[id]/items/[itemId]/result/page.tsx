// …/result  —  Batch 5a · Ali
//
// Pathway hero, net value, P_min/P_recommended/P_max band. HOLD and REVIEW
// are branches of this screen, not separate routes. Escalate-to-admin must
// actually flag the pickup + write a note.
//
...
export default function Page() {
  return (
    <AppShell title="Result" showBack hideNav>
      <PagePadding>
        <h1 className="text-xl font-semibold text-text-primary">Result</h1>
