// /job/[id]/scan  —  Batch 3 · Ali
//
// Optional path — manual entry is primary. 'Generate QR' is deferred: it
// implies physical labelling we cannot demo.
//
...
export default function Page() {
  return (
    <AppShell title="Scan" showBack hideNav>
      <PagePadding>
