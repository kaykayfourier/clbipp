...
//
// Writes offered → collected + PickupReceipt + the agent-fee WalletTxn.
//
...
export default function Page() {
  return (
    <AppShell title="Receipt" showBack hideNav>
      <PagePadding>
        <h1 className="text-xl font-semibold text-text-primary">Receipt</h1>
