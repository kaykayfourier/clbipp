...
//
// Lifecycle timeline. Use lifecycle-view.tsx from @clbipp/ui — do NOT re-
// declare the stage list, and do not build the wireframe's invented 6-stage
// timeline (D5/W4).
//
...
export default function Page() {
  return (
    <AppShell title="Pickup" showBack backHref="/pickups" hideNav>
      <PagePadding>
        <h1 className="text-xl font-semibold text-text-primary">Pickup</h1>
