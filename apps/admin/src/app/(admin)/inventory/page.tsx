...
//
// Keep the <h1> text ("Inventory") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Facility stock by chemistry, capacity gauges, dwell alerts.</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen C01 · not built yet · batch 10
      </p>
    </>
  )
}
