...
//
// Keep the <h1> text ("Dispatch board") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Unassigned requests waiting for an agent. Oldest first.</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen B02 · not built yet · batch 3
      </p>
    </>
  )
}
