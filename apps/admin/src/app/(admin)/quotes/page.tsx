// D03 · Quote queue — Batch 12, owner C — Ali.
//
...
//
// Keep the <h1> text ("Quote queue") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Every priced item — engine-quoted and flat-rate alike (AD1).</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen D03 · not built yet · batch 12
      </p>
    </>
  )
}
