...
//
// Keep the <h1> text ("Dispatch manifests") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Draft, dispatched, received and reconciled shipments to recyclers.</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen C02 · not built yet · batch 6
      </p>
    </>
  )
}
