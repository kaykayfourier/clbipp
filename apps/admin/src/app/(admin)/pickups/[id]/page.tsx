...
//
// Keep the <h1> text ("Pickup detail") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Items, vendor, agent, offer, timeline, custody and documents.</p>
      </div>
      ...
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen B05 · not built yet · batch 5
      </p>
    </>
  )
}
