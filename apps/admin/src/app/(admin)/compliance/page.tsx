// F01 · Compliance — Batch 13, owner B — Khalid.
//
...
//
// Keep the <h1> text ("Compliance") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Mass handled, recovery by metal, certificate feed and CPCB export.</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen F01 · not built yet · batch 13
      </p>
    </>
  )
}
