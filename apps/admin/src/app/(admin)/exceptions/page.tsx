...
//
// Keep the <h1> text ("Exception queue") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Open holds and reviews, resolved as retest, override or reject.</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen D05 · not built yet · batch 14
      </p>
    </>
  )
}
