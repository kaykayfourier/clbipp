...
//
// Keep the <h1> text ("Lifecycle control") when you do: scripts/smoke.mjs asserts on it,
  ...
  return (
    <>
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">Stage advances, by the unit each stage actually belongs to (AD5).</p>
      </div>
      <p className="font-mono text-[10px] tracking-[0.09em] uppercase text-text-secondary">
        Screen B06 · not built yet · batch 6
      </p>
    </>
  )
}
